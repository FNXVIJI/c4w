  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        }}><Text style={{ padding: 15, fontWeight: '500', textAlign: 'center', color: 'rgba(34, 42, 53, 0.6)', }} onPress={() => previousForm()}>Back</Text></TouchableOpacity>
        <TouchableOpacity style={{
        ...
        }} onPress={() => applynow()}><Text style={{ padding: 15, fontWeight: '500', textAlign: "center", color: 'white' }}>Next Step</Text></TouchableOpacity>
